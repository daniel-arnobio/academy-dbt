with 
    ...
    , fact_metrics as (
        select 
           -- {{ dbt_utils.generate_surrogate_key(['address_sk', 'credit_card_sk', 'customer_sk', 'fact_table.metric_date', 'dim_order_status.sales_reason_sk', 'product_sk']) }} as metrics_sk
            dim_address.address_sk
            --, dim_credit_card.credit_card_sk
            --, dim_customer.customer_sk
            , fact_table.metric_date
